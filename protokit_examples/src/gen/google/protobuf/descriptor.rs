...
pub struct FieldDescriptorProto__Type(pub u32);
#[protoenum]
impl FieldDescriptorProto__Type {
    #[var(1u32, "TYPE_DOUBLE")]
    pub const TYPE_DOUBLE: FieldDescriptorProto__Type = FieldDescriptorProto__Type(1u32);
    #[var(2u32, "TYPE_FLOAT")]
    pub const TYPE_FLOAT: FieldDescriptorProto__Type = FieldDescriptorProto__Type(2u32);
    #[var(3u32, "TYPE_INT64")]
    pub const TYPE_INT64: FieldDescriptorProto__Type = FieldDescriptorProto__Type(3u32);
    #[var(4u32, "TYPE_UINT64")]
    pub const TYPE_UINT64: FieldDescriptorProto__Type = FieldDescriptorProto__Type(4u32);
    #[var(5u32, "TYPE_INT32")]
    pub const TYPE_INT32: FieldDescriptorProto__Type = FieldDescriptorProto__Type(5u32);
    #[var(6u32, "TYPE_FIXED64")]
    pub const TYPE_FIXED64: FieldDescriptorProto__Type = FieldDescriptorProto__Type(
        6u32,
    );
    #[var(7u32, "TYPE_FIXED32")]
    pub const TYPE_FIXED32: FieldDescriptorProto__Type = FieldDescriptorProto__Type(
        7u32,
    );
    #[var(8u32, "TYPE_BOOL")]
    pub const TYPE_BOOL: FieldDescriptorProto__Type = FieldDescriptorProto__Type(8u32);
    #[var(9u32, "TYPE_STRING")]
    pub const TYPE_STRING: FieldDescriptorProto__Type = FieldDescriptorProto__Type(9u32);
    #[var(10u32, "TYPE_GROUP")]
    pub const TYPE_GROUP: FieldDescriptorProto__Type = FieldDescriptorProto__Type(10u32);
    #[var(11u32, "TYPE_MESSAGE")]
    pub const TYPE_MESSAGE: FieldDescriptorProto__Type = FieldDescriptorProto__Type(
        11u32,
    );
    #[var(12u32, "TYPE_BYTES")]
    pub const TYPE_BYTES: FieldDescriptorProto__Type = FieldDescriptorProto__Type(12u32);
    #[var(13u32, "TYPE_UINT32")]
    pub const TYPE_UINT32: FieldDescriptorProto__Type = FieldDescriptorProto__Type(
        13u32,
    );
    #[var(14u32, "TYPE_ENUM")]
    pub const TYPE_ENUM: FieldDescriptorProto__Type = FieldDescriptorProto__Type(14u32);
    #[var(15u32, "TYPE_SFIXED32")]
    pub const TYPE_SFIXED32: FieldDescriptorProto__Type = FieldDescriptorProto__Type(
        15u32,
    );
    #[var(16u32, "TYPE_SFIXED64")]
    pub const TYPE_SFIXED64: FieldDescriptorProto__Type = FieldDescriptorProto__Type(
        16u32,
    );
    #[var(17u32, "TYPE_SINT32")]
    pub const TYPE_SINT32: FieldDescriptorProto__Type = FieldDescriptorProto__Type(
        17u32,
    );
    #[var(18u32, "TYPE_SINT64")]
    pub const TYPE_SINT64: FieldDescriptorProto__Type = FieldDescriptorProto__Type(
        18u32,
    );
}
#[derive(Default, Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
pub struct FieldDescriptorProto__Label(pub u32);
#[protoenum]
impl FieldDescriptorProto__Label {
    #[var(1u32, "LABEL_OPTIONAL")]
    pub const LABEL_OPTIONAL: FieldDescriptorProto__Label = FieldDescriptorProto__Label(
        1u32,
    );
    #[var(2u32, "LABEL_REQUIRED")]
    pub const LABEL_REQUIRED: FieldDescriptorProto__Label = FieldDescriptorProto__Label(
        2u32,
    );
    #[var(3u32, "LABEL_REPEATED")]
    pub const LABEL_REPEATED: FieldDescriptorProto__Label = FieldDescriptorProto__Label(
        3u32,
    );
}
#[derive(Default, Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
pub struct FileOptions__OptimizeMode(pub u32);
#[protoenum]
impl FileOptions__OptimizeMode {
    #[var(1u32, "SPEED")]
    pub const SPEED: FileOptions__OptimizeMode = FileOptions__OptimizeMode(1u32);
    #[var(2u32, "CODE_SIZE")]
    pub const CODE_SIZE: FileOptions__OptimizeMode = FileOptions__OptimizeMode(2u32);
    #[var(3u32, "LITE_RUNTIME")]
    pub const LITE_RUNTIME: FileOptions__OptimizeMode = FileOptions__OptimizeMode(3u32);
}
#[derive(Default, Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
pub struct FieldOptions__CType(pub u32);
#[protoenum]
impl FieldOptions__CType {
    #[var(0u32, "STRING")]
    pub const STRING: FieldOptions__CType = FieldOptions__CType(0u32);
    #[var(1u32, "CORD")]
    pub const CORD: FieldOptions__CType = FieldOptions__CType(1u32);
    #[var(2u32, "STRING_PIECE")]
    pub const STRING_PIECE: FieldOptions__CType = FieldOptions__CType(2u32);
}
#[derive(Default, Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
pub struct FieldOptions__JSType(pub u32);
#[protoenum]
impl FieldOptions__JSType {
    #[var(0u32, "JS_NORMAL")]
    pub const JS_NORMAL: FieldOptions__JSType = FieldOptions__JSType(0u32);
    #[var(1u32, "JS_STRING")]
    pub const JS_STRING: FieldOptions__JSType = FieldOptions__JSType(1u32);
    #[var(2u32, "JS_NUMBER")]
    pub const JS_NUMBER: FieldOptions__JSType = FieldOptions__JSType(2u32);
}
#[derive(Default, Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
pub struct MethodOptions__IdempotencyLevel(pub u32);
#[protoenum]
impl MethodOptions__IdempotencyLevel {
    #[var(0u32, "IDEMPOTENCY_UNKNOWN")]
    pub const IDEMPOTENCY_UNKNOWN: MethodOptions__IdempotencyLevel = MethodOptions__IdempotencyLevel(
        0u32,
    );
    #[var(1u32, "NO_SIDE_EFFECTS")]
    pub const NO_SIDE_EFFECTS: MethodOptions__IdempotencyLevel = MethodOptions__IdempotencyLevel(
        1u32,
    );
    #[var(2u32, "IDEMPOTENT")]
    pub const IDEMPOTENT: MethodOptions__IdempotencyLevel = MethodOptions__IdempotencyLevel(
        2u32,
    );
}
...
pub struct DescriptorProto {
    ...
    pub extension_range: Vec<DescriptorProto__ExtensionRange>,
    ...
    pub reserved_range: Vec<DescriptorProto__ReservedRange>,
...
#[derive(Debug, Default, Clone, PartialEq, Proto)]
pub struct DescriptorProto__ExtensionRange {
...
#[derive(Debug, Default, Clone, PartialEq, Proto)]
pub struct DescriptorProto__ReservedRange {
    #[field(1u32, "start", varint, optional)]
    pub start: Option<i32>,
    #[field(2u32, "end", varint, optional)]
    pub end: Option<i32>,
...
pub struct FieldDescriptorProto {
    ...
    pub label: Option<FieldDescriptorProto__Label>,
    #[field(5u32, "type", protoenum, optional)]
    pub r#type: Option<FieldDescriptorProto__Type>,
...
pub struct EnumDescriptorProto {
    ...
    pub reserved_range: Vec<EnumDescriptorProto__EnumReservedRange>,
...
#[derive(Debug, Default, Clone, PartialEq, Proto)]
pub struct EnumDescriptorProto__EnumReservedRange {
    #[field(1u32, "start", varint, optional)]
    pub start: Option<i32>,
    #[field(2u32, "end", varint, optional)]
    pub end: Option<i32>,
...
pub struct FileOptions {
    ...
    pub optimize_for: Option<FileOptions__OptimizeMode>,
...
pub struct FieldOptions {
    ...
    pub ctype: Option<FieldOptions__CType>,
    #[field(2u32, "packed", bool, optional)]
    pub packed: Option<bool>,
    #[field(6u32, "jstype", protoenum, optional)]
    pub jstype: Option<FieldOptions__JSType>,
...
pub struct MethodOptions {
    ...
    pub idempotency_level: Option<MethodOptions__IdempotencyLevel>,
    #[field(999u32, "uninterpreted_option", nested, repeated)]
    pub uninterpreted_option: Vec<UninterpretedOption>,
    #[unknown]
    pub unknown: binformat::UnknownFieldsOwned,
...
pub struct UninterpretedOption {
    ...
    pub name: Vec<UninterpretedOption__NamePart>,
...
#[derive(Debug, Default, Clone, PartialEq, Proto)]
pub struct UninterpretedOption__NamePart {
...
pub struct SourceCodeInfo {
    ...
    pub location: Vec<SourceCodeInfo__Location>,
    #[unknown]
    pub unknown: binformat::UnknownFieldsOwned,
}
#[derive(Debug, Default, Clone, PartialEq, Proto)]
pub struct SourceCodeInfo__Location {
...
pub struct GeneratedCodeInfo {
    ...
    pub annotation: Vec<GeneratedCodeInfo__Annotation>,
    #[unknown]
    pub unknown: binformat::UnknownFieldsOwned,
}
#[derive(Debug, Default, Clone, PartialEq, Proto)]
pub struct GeneratedCodeInfo__Annotation {
    #[field(1u32, "path", varint, repeated)]
    pub path: Vec<i32>,
