...
impl binformat::Encodable for TestAllTypesProto2 {
    ...
    fn encode(&self, buf: &mut binformat::WriteBuffer) -> binformat::Result<()> {
        ...
        Format::<Repeat::<VInt>>::encode(&self.repeated_int32, 248u32, buf)?;
        Format::<Repeat::<VInt>>::encode(&self.repeated_int64, 256u32, buf)?;
        Format::<Repeat::<VInt>>::encode(&self.repeated_uint32, 264u32, buf)?;
        Format::<Repeat::<VInt>>::encode(&self.repeated_uint64, 272u32, buf)?;
        Format::<Repeat::<SInt>>::encode(&self.repeated_sint32, 280u32, buf)?;
        Format::<Repeat::<SInt>>::encode(&self.repeated_sint64, 288u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.repeated_fixed32, 301u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.repeated_fixed64, 305u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.repeated_sfixed32, 317u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.repeated_sfixed64, 321u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.repeated_float, 333u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.repeated_double, 337u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.repeated_bool, 344u32, buf)?;
        ...
        Format::<Repeat::<Enum>>::encode(&self.repeated_nested_enum, 408u32, buf)?;
        Format::<Repeat::<Enum>>::encode(&self.repeated_foreign_enum, 416u32, buf)?;
        ...
        Format::<Repeat::<VInt>>::encode(&self.unpacked_int32, 712u32, buf)?;
        Format::<Repeat::<VInt>>::encode(&self.unpacked_int64, 720u32, buf)?;
        Format::<Repeat::<VInt>>::encode(&self.unpacked_uint32, 728u32, buf)?;
        Format::<Repeat::<VInt>>::encode(&self.unpacked_uint64, 736u32, buf)?;
        Format::<Repeat::<SInt>>::encode(&self.unpacked_sint32, 744u32, buf)?;
        Format::<Repeat::<SInt>>::encode(&self.unpacked_sint64, 752u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.unpacked_fixed32, 765u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.unpacked_fixed64, 769u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.unpacked_sfixed32, 781u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.unpacked_sfixed64, 785u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.unpacked_float, 797u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.unpacked_double, 801u32, buf)?;
        Format::<Repeat::<Fix>>::encode(&self.unpacked_bool, 808u32, buf)?;
        Format::<Repeat::<Enum>>::encode(&self.unpacked_nested_enum, 816u32, buf)?;
        ...
        Format::<VInt>::encode(&self.group_int32, 1616u32, buf)?;
        Format::<VInt>::encode(&self.group_uint32, 1624u32, buf)?;
        Format::<VInt>::encode(&self.default_int32, 1928u32, buf)?;
        Format::<VInt>::encode(&self.default_int64, 1936u32, buf)?;
        Format::<VInt>::encode(&self.default_uint32, 1944u32, buf)?;
        Format::<VInt>::encode(&self.default_uint64, 1952u32, buf)?;
        Format::<SInt>::encode(&self.default_sint32, 1960u32, buf)?;
        Format::<SInt>::encode(&self.default_sint64, 1968u32, buf)?;
        Format::<Fix>::encode(&self.default_fixed32, 1981u32, buf)?;
        Format::<Fix>::encode(&self.default_fixed64, 1985u32, buf)?;
        Format::<Fix>::encode(&self.default_sfixed32, 1997u32, buf)?;
        Format::<Fix>::encode(&self.default_sfixed64, 2001u32, buf)?;
        Format::<Fix>::encode(&self.default_float, 2013u32, buf)?;
        Format::<Fix>::encode(&self.default_double, 2017u32, buf)?;
        Format::<Fix>::encode(&self.default_bool, 2024u32, buf)?;
        Format::<Bytes>::encode(&self.default_string, 2034u32, buf)?;
        Format::<Bytes>::encode(&self.default_bytes, 2042u32, buf)?;
        ...
        Format::<VInt>::encode(&self.extension_int32, 960u32, buf)?;
        match &self.oneof_field {
            TestAllTypesProto2OneOfOneofField::OneofUint32(value) => {
...
impl binformat::Encodable for TestAllTypesProto2MessageSetCorrect {
    ...
    fn encode(&self, buf: &mut binformat::WriteBuffer) -> binformat::Result<()> {
        use binformat::format::*;
        Format::<Nest>::encode(&self.message_set_extension, 33082498u32, buf)?;
        binformat::Encodable::encode(&self._unknown, buf)?;
        Ok(())
    }
}
...
impl binformat::Encodable for TestAllTypesProto2MessageSetCorrectExtension1 {
    ...
    fn encode(&self, buf: &mut binformat::WriteBuffer) -> binformat::Result<()> {
        use binformat::format::*;
        Format::<Nest>::encode(&self.message_set_extension, 12382154u32, buf)?;
        Format::<Bytes>::encode(&self.str, 202u32, buf)?;
        binformat::Encodable::encode(&self._unknown, buf)?;
        Ok(())
    }
}
...
impl binformat::Encodable for TestAllTypesProto2MessageSetCorrectExtension2 {
    ...
    fn encode(&self, buf: &mut binformat::WriteBuffer) -> binformat::Result<()> {
        use binformat::format::*;
        Format::<Nest>::encode(&self.message_set_extension, 33082498u32, buf)?;
        Format::<VInt>::encode(&self.i, 72u32, buf)?;
        binformat::Encodable::encode(&self._unknown, buf)?;
        Ok(())
    }
}
...
impl binformat::Encodable for UnknownToTestAllTypes {
    ...
    fn encode(&self, buf: &mut binformat::WriteBuffer) -> binformat::Result<()> {
        use binformat::format::*;
        Format::<VInt>::encode(&self.optional_int32, 8008u32, buf)?;
        Format::<Bytes>::encode(&self.optional_string, 8018u32, buf)?;
        Format::<Nest>::encode(&self.nested_message, 8026u32, buf)?;
        Format::<VInt>::encode(&self.a, 8u32, buf)?;
        Format::<Fix>::encode(&self.optional_bool, 8048u32, buf)?;
        Format::<Repeat::<VInt>>::encode(&self.repeated_int32, 8088u32, buf)?;
        binformat::Encodable::encode(&self._unknown, buf)?;
        Ok(())
    }
}
...
impl binformat::Encodable for OneStringProto2 {
    ...
    fn encode(&self, buf: &mut binformat::WriteBuffer) -> binformat::Result<()> {
        use binformat::format::*;
        Format::<Bytes>::encode(&self.data, 10u32, buf)?;
        binformat::Encodable::encode(&self._unknown, buf)?;
        Ok(())
    }
}
...
impl binformat::Encodable for ProtoWithKeywords {
    ...
    fn encode(&self, buf: &mut binformat::WriteBuffer) -> binformat::Result<()> {
        use binformat::format::*;
        Format::<VInt>::encode(&self.inline, 8u32, buf)?;
        Format::<Bytes>::encode(&self.concept, 18u32, buf)?;
        Format::<Repeat::<Bytes>>::encode(&self.requires, 26u32, buf)?;
        binformat::Encodable::encode(&self._unknown, buf)?;
        Ok(())
    }
}
