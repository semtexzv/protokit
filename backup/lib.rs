    ...
    T: Decodable + Default,
{
    ...
    fn decode<'i, 'b>(&'i mut self, buf: ReadBuffer<'b>) -> Result<ReadBuffer<'b>> {
        self.get_or_insert_with(Default::default).deref_mut().decode(buf)
    }
    fn merge_field<'i, 'b>(&'i mut self, tag: u32, buf: ReadBuffer<'b>) -> Result<ReadBuffer<'b>> {
...
pub trait IsPresent {
    #[inline(always)]
    fn is_present(&self, proto3: bool) -> bool {
        true
    }
}

macro_rules! is_present_default {
    ($($t:ty),*) => {
        $(impl IsPresent for $t {
            #[inline(always)]
            fn is_present(&self, proto3: bool) -> bool {
                self != &<$t>::default()
            }
...
is_present_default!(i32, u32, i64, u64, f32, f64, bool, String);
...
impl<K, V> IsPresent for HashMap<K, V> {
    #[inline(always)]
    fn is_present(&self, proto3: bool) -> bool {
        !self.is_empty()
    }
